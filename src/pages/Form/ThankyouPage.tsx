          ...
          <div className="text-center mb-8">
            ...
            <div className="text-left space-y-6">
              <p className="text-gray-700 leading-relaxed">
                Estamos selecionando <strong>A DEDO</strong> pessoas para uma
                consultoria individual gratuita, onde mostraremos um conteúdo
                que ninguém do mercado está falando como deveria.
              </p>

              <p className="text-gray-700 leading-relaxed">
                Se você tiver cada mínimo detalhe que precisamos para você ser o
                nosso próximo case de sucesso, os fundadores da empresa (Kauan
                Vecker ou Arthur Ramos) vão te chamar por DM do Instagram ou
                WhatsApp.
              </p>

              <p className="text-gray-700 leading-relaxed">
                Enquanto isso, clique no botão abaixo para acessar nossa
                comunidade totalmente gratuita, que vai te ajudar a começar ou
