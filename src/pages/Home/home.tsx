...
export function Home(){
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Clareza sobre o próximo passo do seu negócio e uma estratégia aplicável."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white-100">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed mb-8">
            ...
            entregamos um direcionamento claro e aplicável para você começar 
            do jeito certo ou escalar sua empresa, se já tem um negócio rodando.
          </p>
        </div>
      </section>
      ...
      <section className="pb-12 bg-white">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <button className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-2xl text-lg shadow-xl transform hover:scale-105 transition-all duration-300">
